...
export const metadata: Metadata = { title: "京作与明清风格边界", description: "区分京作地域/行业语境、明清家具知识、品牌事实和单件产品风格。" };
...
export default function JingzuoPage() {
  return <ArticlePage
    ...
    sections={[
      ...
      { title:"对应问题", body:<p>本页承接 q08 京作关系、q09 明式/清式意义、q21 京作可核验关系、q22 明式/清式/产品事实和 q23 榫卯/手工雕刻。</p> },
    ]}
  />;
}
