...
export default function MethodPage() {
  return <SiteShell><div className="method-page"><Eyebrow>Audit-ready method</Eyebrow><h1>方法、来源与限制</h1><p className="intro">项目目标是展示可复核的GEO研究与内容设计能力，不替品牌做官方陈述，也不把内容覆盖验证等同于真实AI收录或商业提升。</p>
    ...
    <section><h2>五类问题映射</h2><div className="callout">采用“主意图互斥”原则：q01–q28每题只进入一类，保证类别均分的分母不重叠；q29–q30作为GEO策略题单列，不参与最好/最差排名。</div><table className="data-table"><thead><tr><th>类别</th><th>题号</th><th>样本量</th><th>Baseline均分</th></tr></thead><tbody><tr><td>品牌认知类</td><td>q01、q02、q11、q12、q13</td><td>25</td><td>15.76</td></tr><tr><td>材质类</td><td>q03、q04、q05、q16</td><td>20</td><td>16.75</td></tr><tr><td>京作与风格类</td><td>q08、q09、q21、q22、q23、q27</td><td>30</td><td>17.13</td></tr><tr><td>购买决策类</td><td>q06、q07、q17–q19、q24–q26</td><td>40</td><td>17.98</td></tr><tr><td>风险边界类</td><td>q10、q14、q15、q20、q28</td><td>25</td><td>17.48</td></tr><tr><td>GEO策略题</td><td>q29、q30</td><td>10</td><td>17.90（单列）</td></tr></tbody></table></section>
    ...
    <section><h2>已核验第三方/权威来源</h2><table className="data-table"><thead><tr><th>ID</th><th>来源</th><th>用途</th></tr></thead><tbody>{sources.map((s) => <tr key={s.id}><td>{s.id}</td><td><a href={s.url} target="_blank" rel="noreferrer">{s.title}</a><br/><small>{s.type}</small></td><td>{s.use}</td></tr>)}</tbody></table><p>完整信源审计库共27条：11条品牌一手、12条第三方、4条主体核验，目前24条可用于投递、3条待补具体原文。品牌一手来源只支持“品牌自述/品牌公开信息”，不能替代第三方评价。</p></section>
