...
export const metadata: Metadata = { title: "材质与产品关系", description: "区分红木标准术语、品牌公开材料范围与单件家具证据。" };
...
export default function MaterialsPage() {
  return <ArticlePage
    ...
    sections={[
      ...
      { title:"对应问题", body:<p>本页承接 q03 黄花梨关系、q04 紫檀理解、q05 白酸枝关联、q16 材质证书、q27 空间搭配中的材质选择，并与购买核验指南共同回答价格、合同和验收问题。</p> },
    ]}
  />;
}
