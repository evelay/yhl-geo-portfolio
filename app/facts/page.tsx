...
export default function FactsPage() {
  return (
    <ArticlePage
        ...
        assetProblem="解决品牌主体、同名对象、官网来源和成立时间口径混淆，把AI容易拼接的品牌叙述拆成可核验事实、来源范围和不可越界结论。"
        breadcrumbs={[{ label: "首页", href: "/" }, { label: "内容策略", href: "/content-governance" }, { label: "品牌事实与定位" }]}
        schemaPath="/facts/"
        sourceIds={["B-008","B-009","B-011"]}
        related={[{label:"如何区分同名主体？",href:"/disambiguation"},{label:"官网一定是第三方证据吗？",href:"/faq"},{label:"查看研究方法",href:"/methodology"}]}
        sections={[
          ...
          { title:"对应AI搜索问题", body:<p>本页承接品牌识别、行业定位、品牌比较、主体表述、官网与来源、成立时间、人物关系、荣誉排名和推荐比较等问题。旧测试框架不再作为当前公开主指标展示。</p> },
        ]}
      />
  );
}
