...
- 执行时间：2026-07-20T00:08:31+08:00
- 构建版本：b73e5538413569e75b2af578c54a2299287aba83-working-tree-07d2
...
- 静态 main 正文长度：5364
- JSON-LD 类型：WebPage, WebSite；WebSite 数量：1；WebPage 数量：1；BreadcrumbList 数量：0
- 内链数量：30；外部来源链接数量：0
### 品牌事实页 `/facts`
...
- H1：元亨利品牌事实、来源与信息边界
- 静态 main 正文长度：904
- JSON-LD 类型：BreadcrumbList；WebSite 数量：0；WebPage 数量：0；BreadcrumbList 数量：1
- 内链数量：18；外部来源链接数量：3
### 购买指南页 `/buying-guide`
...
## 三个页面的共性问题
- 首页 `/` 已识别 WebSite + WebPage @graph；字段与首页 H1、可见摘要、canonical 和语言一致。
...
## 页面特有问题
- `/`：首页已识别 WebSite + WebPage @graph，字段与可见页面一致；首页仍不生成 BreadcrumbList。
...
## 输出文件
- `tools/geo-skill/reports/page-audit-pilot-after-home-schema/report.md`
- `tools/geo-skill/reports/page-audit-pilot-after-home-schema/report.json`
- `tools/geo-skill/reports/page-audit-pilot-after-home-schema/run-metadata.json`
- `tools/geo-skill/reports/page-audit-pilot-after-home-schema/findings.csv`
